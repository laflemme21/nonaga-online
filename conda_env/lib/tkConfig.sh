...
# installed.
TK_PREFIX='/users/sc23ksk/nonaga-algorithm/conda_env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/users/sc23ksk/nonaga-algorithm/conda_env'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/users/sc23ksk/nonaga-algorithm/conda_env/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/users/sc23ksk/nonaga-algorithm/conda_env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/users/sc23ksk/nonaga-algorithm/conda_env/include'
...
# compiled.
TK_SRC_DIR='/users/sc23ksk/nonaga-algorithm/conda_env/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/users/sc23ksk/nonaga-algorithm/conda_env/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/users/sc23ksk/nonaga-algorithm/conda_env/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/users/sc23ksk/nonaga-algorithm/conda_env/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/users/sc23ksk/nonaga-algorithm/conda_env/lib/libtkstub8.6.a'
